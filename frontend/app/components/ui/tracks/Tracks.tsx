      ...
      <div className={styles.tracksContainer}>
        <header className={styles.tracksHeader}>
          ...
          <p className={styles.tracksSubtitle}>
            The tracks you are eligible to win depend on your final project and
            whether you completed your degree&apos;s{" "}
            <Link
              href={"https://www.unlv.edu/provost/gen-ed/milestone"}
              target="_blank"
          ...
          <div className={styles.trackUpper}>
            <div className={styles.trackCard}>
              ...
              <p className={styles.cardDesc}>
                For teams building software projects where no member has
                completed their degree&apos;s milestone course
              </p>
            </div>
            <div className={styles.trackCard}>
              <div className={styles.cardTitle}>
              ...
              <hr className={styles.lineBreak} />
              <p className={styles.cardDesc}>
                For teams building hardware projects where no member has
                completed their degree&apos;s milestone course
              </p>
            </div>
            <div className={styles.trackCard}>
              ...
              <hr className={styles.lineBreak} />
              <p className={styles.cardDesc}>
                For teams building software projects where at least one member
                has completed their degree&apos;s milestone course
              </p>
            </div>
            <div className={styles.trackCard}>
              <div className={styles.cardTitle}>
              ...
              <hr className={styles.lineBreak} />
              <p className={styles.cardDesc}>
                For teams building hardware projects where at least one member
                has completed their degree&apos;s milestone course
              </p>
            </div>
          </div>
